...
import {RateLimitedLibrary, RateLimit} from "./RateLimitedLibrary.sol";
import {RateLimitCommonLibrary} from "./RateLimitedCommonLibrary.sol";
...
abstract contract RateLimitedAllowance is Pausable, Ownable {
    ...
    constructor(address owner, address _spender) Ownable(owner) {
        spender = _spender;
    }
